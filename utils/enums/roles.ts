...
export const ROLES = process.env.ENVIRONMENT == "DEV" ?
    /** @development */
    {
        ...
        TIER: {
            ...
            MYTHIC_FREE_AGENT       : null,                         // not in development server
            EXPERT_FREE_AGENT       : null,                         // not in development server
            APPRENTICE_FREE_AGENT   : null,                         // not in development server
            PROSPECT_FREE_AGENT     : null,                         // not in development server
        }
    } :
    /** @production */
    {
