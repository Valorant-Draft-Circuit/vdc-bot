...
async function setKeeperPick(interaction, overallPickNumber, tier, discordID) {
	...
	if (!userRoles.includes(ROLES.OPERATIONS.ADMIN || ROLES.OPERATIONS.TRANSACTIONS)) return await interaction.editReply({ content: `You don't have the Admin or Transactions role and cannot use this command!` });
